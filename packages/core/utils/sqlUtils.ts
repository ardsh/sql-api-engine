...
row_to_json((SELECT row FROM (${fragment}) row)) AS ${sql.identifier([
  name || 'row_to_json'
])}
`

export const rowsToArray = (fragment: Fragment, name?: string) => sql.fragment`(
...
export const genericFilter = (value: any, statement: Fragment) => {
...
export const arrayDynamicFilter =
  (type = 'text') =>
  (
    ...
    if (filter?.length) {
      return sql.fragment`${field} = ANY(${sql.array(
        filter,
        typeOverride || type
      )})`
    }
...
export const comparisonFilter = (
  ...
  if (isNull || isNotNull) {
    conditions.push(
      isNull
        ? sql.fragment`${field} IS NULL`
        : sql.fragment`${field} IS NOT NULL`
    )
  }
 ...
 */
export const stringFilterType = z.union([
  z.string(),
  z.object({
...
export const jsonbFilter = (
  ...
  if (value !== null && typeof value === 'object' && !Array.isArray(value)) {
    ...
    const conditions = Object.entries(value)
      .map(([key, val]) => jsonbFilter(key, val, fullPath))
      .filter(notEmpty)
    ...
    const pathExpr = sql.join(
      fullPath.flatMap((el, idx) => {
        if (idx === 0) {
...
export const filters = {
  dateFilter:
    (field: Fragment | string | string[]) =>
    (value: Parameters<typeof dateFilter>[0]) =>
      dateFilter(
        value,
        typeof field === 'string'
  ...
  stringFilter:
    (field: Fragment | string | string[]) =>
    (value: Parameters<typeof stringFilter>[0]) =>
      stringFilter(
        value,
        typeof field === 'string'
          ? sql.identifier([field])
  ...
  comparisonFilter:
    (field: Fragment | string | string[]) =>
    (value: Parameters<typeof comparisonFilter>[0]) =>
      comparisonFilter(
        value,
        typeof field === 'string'
          ? sql.identifier([field])
  ...
  jsonbContainsFilter:
    (field: Fragment | string | string[]) =>
    (value: Parameters<typeof jsonbContainsFilter>[0]) =>
      jsonbContainsFilter(
        value,
        typeof field === 'string'
          ? sql.identifier([field])
  ...
  inArrayFilter:
    (field: Fragment | string | string[], type = 'text') =>
    (value: Parameters<typeof arrayFilter>[0]) =>
      arrayFilter(
        value,
        typeof field === 'string'
          ? sql.identifier([field])
  ...
  booleanFilter:
    (trueStatement: Fragment | string | string[], falseStatement?: Fragment) =>
    (value: Parameters<typeof booleanFilter>[0]) =>
      booleanFilter(
        value,
        typeof trueStatement === 'string'
          ? sql.identifier([trueStatement])
          : Array.isArray(trueStatement)
          ? sql.identifier(trueStatement)
          : trueStatement,
        falseStatement
      )
